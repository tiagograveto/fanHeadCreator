...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final HolographicdisplaysLibraryAccessors laccForHolographicdisplaysLibraryAccessors = new HolographicdisplaysLibraryAccessors(owner);
    ...
    private final MojangLibraryAccessors laccForMojangLibraryAccessors = new MojangLibraryAccessors(owner);
    ...
    /**
     * Returns the group of libraries at holographicdisplays
     */
    public HolographicdisplaysLibraryAccessors getHolographicdisplays() { return laccForHolographicdisplaysLibraryAccessors; }
    ...
    /**
     * Returns the group of libraries at mojang
     */
    public MojangLibraryAccessors getMojang() { return laccForMojangLibraryAccessors; }
    ...
    public static class HolographicdisplaysLibraryAccessors extends SubDependencyFactory {

        public HolographicdisplaysLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for api (com.gmail.filoghost.holographicdisplays:holographicdisplays-api)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getApi() { return create("holographicdisplays.api"); }
    ...
    public static class MojangLibraryAccessors extends SubDependencyFactory {

        public MojangLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for authlib (com.mojang:authlib)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getAuthlib() { return create("mojang.authlib"); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: authlib (1.5.21)
            ...
            /**
             * Returns the version associated to this alias: commonscode (1.15)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getCommonscode() { return getVersion("commonscode"); }

            /**
             * Returns the version associated to this alias: holographicdisplays (2.4.9)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getHolographicdisplays() { return getVersion("holographicdisplays"); }
